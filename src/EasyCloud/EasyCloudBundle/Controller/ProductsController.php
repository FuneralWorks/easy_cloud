...
use EasyCloud\EasyCloudBundle\Entity\Products;
...
class ProductsController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $products = $em->getRepository('EasyCloudBundle:Products')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('EasyCloud\EasyCloudBundle\Form\ProductsType', $product);
    ...
    {
        $deleteForm = $this->createDeleteForm($product);
        $editForm = $this->createForm('EasyCloud\EasyCloudBundle\Form\ProductsType', $product);

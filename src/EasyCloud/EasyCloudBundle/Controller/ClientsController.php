...
use EasyCloud\EasyCloudBundle\Entity\Clients;
...
class ClientsController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $clients = $em->getRepository('EasyCloudBundle:Clients')->findAll();
    ...
    {
        $client = new Clients();
        $form = $this->createForm('EasyCloud\EasyCloudBundle\Form\ClientsType', $client);
    ...
    {
        $deleteForm = $this->createDeleteForm($client);
        $editForm = $this->createForm('EasyCloud\EasyCloudBundle\Form\ClientsType', $client);
